...
- **Created:** 2026-07-30
- **Owner:** wabbazzar
- **Status:** complete — native Mac and server Linux gates verified; CI pending
- **Priority:** high
- **Type:** bugfix
...
- GitHub checks and Pages deployment: pending server push.
